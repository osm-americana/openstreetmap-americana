...
const motorwayToTertiary = [...motorwayToPrimary, "secondary", "tertiary", "busway"];
...
export const label = {
  ...
  paint: {
    ...
    "text-halo-color": [
      ...
      16,
      [...classSelector, "ferry", Color.waterFill, motorwayToTrunk, "white", Color.backgroundFill],
      17,
      [...classSelector, "ferry", Color.waterFill, motorwayToTertiary, "white", Color.backgroundFill],
      18,
