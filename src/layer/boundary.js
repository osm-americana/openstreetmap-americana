...
export const administrative = {
  ...
  paint: {
    ...
    "line-opacity": [
      "step",
      ["zoom"],
      ["match", ["get", "admin_level"], 2, 0.65, /* else */ 0],
      3,
    ...
    "line-width": [
      ...
      4,
      ["match", ["get", "admin_level"], 2, 1.5, 3, 0.5, 4, 0.5, /* else */ 1],
      5,
      ["match", ["get", "admin_level"], 2, 1.5, 3, 0.8, 4, 0.8, /* else */ 1],
      7,
      ["match", ["get", "admin_level"], 2, 2.115, 3, 1.1, 4, 1.1, /* else */ 1],
    ],
  },
  filter: [
    "all",
